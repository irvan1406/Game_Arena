...
window.GameConfig = {
  version: '2.4.0',
  title: 'Arena Tactics',
  ownerAccount: {username:'Irvan',password:'1',displayName:'Irvan',role:'owner'},
  economy: {startGold:5000,startGems:250,winGold:120,loseGold:35,winTrophy:30,loseTrophy:18,upgradeBaseCost:80,maxCardLevel:15},
  battle: {durationSeconds:180,maxEnergy:10,startEnergy:5,normalEnergyPerSecond:0.72,doubleEnergyPerSecond:1.25},
  arenas: [
